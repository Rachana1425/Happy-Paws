        ...
        LocationListener
{
                ...
                if(!TextUtils.isEmpty(address))
                {
                    ...
                    try
                    {
                        ...
                        if(addressList != null)
                        {
                            ...
                            {
                                Address userAddresss =  addressList.get(i);
                                LatLng latLng = new LatLng(userAddresss.getLatitude(), userAddresss.getLongitude());
    ...
    private String  getUrl(double latitude,double longitude, String nearbyPlace)
    {
        ...
        googleURL.append("&key=" + "AIzaSyDQ3YFOvkB6dddY7ZFeWhC65FxrQEQBIlA");
