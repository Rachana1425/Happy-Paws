...
public class Surgical extends AppCompatActivity {
    ...
    private void CallButton() {
        ...
        if (number.trim().length() > 0) {
            if (ContextCompat.checkSelfPermission(Surgical.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(Surgical.this, new String[]{Manifest.permission.CALL_PHONE}, REQUEST_CALL);
            } else {
