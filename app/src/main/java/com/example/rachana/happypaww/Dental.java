...
public class Dental extends AppCompatActivity {
    ...
    private void CallButton() {
        ...
        if (number.trim().length() > 0) {
            if (ContextCompat.checkSelfPermission(Dental.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(Dental.this, new String[]{Manifest.permission.CALL_PHONE}, REQUEST_CALL);
            } else {
