...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fooddes = (TextView)findViewById(R.id.textdes);
        foodimg = (ImageView)findViewById(R.id.ivimage);

        Bundle mBundle = getIntent().getExtras();

        if(mBundle!=null){
            fooddes.setText(mBundle.getString("Description"));
            foodimg.setImageResource(mBundle.getInt("Image"));
        }
