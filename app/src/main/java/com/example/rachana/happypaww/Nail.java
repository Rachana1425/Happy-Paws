...
public class Nail extends AppCompatActivity {
    ...
    private void CallButton() {
        ...
        if (number.trim().length() > 0) {
            if (ContextCompat.checkSelfPermission(Nail.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(Nail.this, new String[]{Manifest.permission.CALL_PHONE}, REQUEST_CALL);
            } else {
